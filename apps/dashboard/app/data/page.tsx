...
// (Online order QR codes moved to their own page — see /personalization/qr-codes.)
  ...
  return (
    <AppShell>
      ...
      <div className="notice" style={{ marginBottom: 20 }}>
        Selling through Swiggy/Zomato? Generate <a href="/personalization/qr-codes">online order QR codes</a> to
        capture those customers too.
      </div>

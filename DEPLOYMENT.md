...
3. Run migrations and seed **from your local machine**, pointed at Supabase:
   ...
   pnpm db:migrate      # uses DIRECT_DATABASE_URL automatically
   pnpm db:seed         # seeds Dadu's — uses DATABASE_URL
   ```
...
2. **Environment Variables** (Project Settings → Environment Variables):
   ...
   | `ANTHROPIC_API_KEY` | optional; omit to use the mock copywriter |
